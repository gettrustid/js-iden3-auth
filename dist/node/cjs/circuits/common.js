...
function getResolverByID(resolvers, id) {
    const userDID = js_iden3_core_custom_1.DID.parseFromId(id);
    return getResolverByDID(resolvers, userDID);
}
exports.getResolverByID = getResolverByID;
function getResolverByDID(resolvers, did) {
    const { blockchain, networkId } = js_iden3_core_custom_1.DID.decodePartsFromId(js_iden3_core_custom_1.DID.idFromDID(did));
